        <div class="row">
        	<div class="col s12 m9">
        		<h3 class="cyan-text">Masyarakat</h3>
        	</div>
        ...
        <table id="example" class="display responsive-table" style="width:100%">
        	<a class="waves-effect waves-light btn modal-trigger blue" href="#modal1">add</a>
        	...
        	<tbody>
				...
				while ($r = mysqli_fetch_assoc($query)) { ?>
        			<tr>
        				...
        				<td><a class="btn teal modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" class="btn btn-danger" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>">Hapus</a></td>
